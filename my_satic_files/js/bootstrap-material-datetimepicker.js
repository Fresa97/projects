(function ($, moment)
{
   ...
   function Plugin(element, options)
   {
      ...
      this.params = {date: true, time: true, format: 'yyyy-MM-dd', minDate: null, maxDate: null, currentDate: null, lang: 'es', weekStart: 0, shortTime: false, clearButton: false, nowButton: false, cancelText: 'Cancelar', okText: 'OK', clearText: 'Limpiar', nowText: 'Ahora', switchOnClick: false};
